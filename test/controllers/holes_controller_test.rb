...
class HolesControllerTest < ActionController::TestCase
  ...
  test "should create hole" do
    assert_difference('Hole.count') do
      post :create, hole: { handicap: @hole.handicap, identifier: @hole.identifier, number: @hole.number, par: @hole.par }
    end
  ...
  test "should update hole" do
    patch :update, id: @hole, hole: { handicap: @hole.handicap, identifier: @hole.identifier, number: @hole.number, par: @hole.par }
    assert_redirected_to hole_path(assigns(:hole))
  end
